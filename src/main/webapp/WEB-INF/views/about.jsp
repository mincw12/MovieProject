				...
				<div class="col-lg-9 offset-lg-3 bg-two">
					<div class="philosophy-content">
						...
						<ul class="phisophy-list">
							<li><div class="thumb">
									<img src="./assets/images/philosophy/icon1.png"
										alt="philosophy">
								</div>
								<h5 class="title">Honesty & Fairness</h5></li>
							<li><div class="thumb">
									<img src="./assets/images/philosophy/icon2.png"
										alt="philosophy">
								</div>
								<h5 class="title">Clarity & Transparency</h5></li>
							<li><div class="thumb">
									<img src="./assets/images/philosophy/icon3.png"
										alt="philosophy">
								</div>
				...
				<div class="speaker-slider owl-carousel owl-theme">
					<div class="speaker-item">
						<div class="speaker-thumb">
							<a href="event-speaker"><img
								src="./assets/images/speaker/speaker01.jpg" alt="speaker"></a>
						</div>
					...
					<div class="speaker-item">
						<div class="speaker-thumb">
							<a href="event-speaker"><img
								src="./assets/images/speaker/speaker02.jpg" alt="speaker"></a>
						</div>
						<div class="speaker-content">
							<h5 class="title">
					...
					<div class="speaker-item">
						<div class="speaker-thumb">
							<a href="event-speaker"><img
								src="./assets/images/speaker/speaker03.jpg" alt="speaker"></a>
						</div>
						<div class="speaker-content">
							<h5 class="title">
					...
					<div class="speaker-item">
						<div class="speaker-thumb">
							<a href="event-speaker"><img
								src="./assets/images/speaker/speaker04.jpg" alt="speaker"></a>
						</div>
						<div class="speaker-content">
							<h5 class="title">
		...
		<div class="container">
			...
			<div class="row justify-content-center gallery-wrapper mb-30-none">
				<div class="col-lg-3 col-sm-6">
					<div class="gallery-item two">
						<div class="gallery-thumb">
							<a href="./assets/images/gallery/gallery05.jpg" class="img-pop"><i
								class="flaticon-loupe"></i></a><img
								src="./assets/images/gallery/gallery05.jpg" alt="gallery">
						</div>
					</div>
					<div class="gallery-item two">
						<div class="gallery-thumb">
							<a href="./assets/images/gallery/gallery06.jpg" class="img-pop"><i
								class="flaticon-loupe"></i></a><img
								src="./assets/images/gallery/gallery06.jpg" alt="gallery">
						</div>
					</div>
					<div class="gallery-item two">
						<div class="gallery-thumb">
							<a href="./assets/images/gallery/gallery07.jpg" class="img-pop"><i
								class="flaticon-loupe"></i></a><img
								src="./assets/images/gallery/gallery07.jpg" alt="gallery">
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-lg-3 order-lg-1">
					<div class="gallery-item two">
						<div class="gallery-thumb">
							<a href="./assets/images/gallery/gallery11.jpg" class="img-pop"><i
								class="flaticon-loupe"></i></a><img
								src="./assets/images/gallery/gallery11.jpg" alt="gallery">
						</div>
					</div>
					<div class="gallery-item two">
						<div class="gallery-thumb">
							<a href="./assets/images/gallery/gallery12.jpg" class="img-pop"><i
								class="flaticon-loupe"></i></a><img
								src="./assets/images/gallery/gallery12.jpg" alt="gallery">
						</div>
					</div>
					<div class="gallery-item two">
						<div class="gallery-thumb">
							<a href="./assets/images/gallery/gallery13.jpg" class="img-pop"><i
								class="flaticon-loupe"></i></a><img
								src="./assets/images/gallery/gallery13.jpg" alt="gallery">
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="gallery-item two">
						<div class="gallery-thumb">
							<a href="./assets/images/gallery/gallery08.jpg" class="img-pop"><i
								class="flaticon-loupe"></i></a><img
								src="./assets/images/gallery/gallery08.jpg" alt="gallery">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="gallery-item two">
								<div class="gallery-thumb">
									<a href="./assets/images/gallery/gallery09.jpg" class="img-pop"><i
										class="flaticon-loupe"></i></a><img
										src="./assets/images/gallery/gallery09.jpg" alt="gallery">
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="gallery-item two">
								<div class="gallery-thumb">
									<a href="./assets/images/gallery/gallery10.jpg" class="img-pop"><i
										class="flaticon-loupe"></i></a><img
										src="./assets/images/gallery/gallery10.jpg" alt="gallery">
								</div>
							</div>
						</div>
					</div>
