						...
						<div class="row justify-content-center">
							<div class="col-sm-6 col-lg-4">
								<div class="sports-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="sport-details">football league tournament</a>
										</h5>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="sports-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="sport-details">world cricket league 2020</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="sports-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="sport-details">basket ball tournament 2020</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="sports-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="sport-details">World Basketball League 2020</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="sports-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="sport-details">World Golf League 2020</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="sports-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="sport-details">World Badminton Tournament</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="sports-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="sport-details">Digital Economy Conference</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="sports-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="sport-details">World Football League 2020</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="sports-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="sport-details">World Bikeracing League</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
