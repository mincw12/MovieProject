...
<body>
	...
	<section class="event-banner-section bg_img"
		data-background="./resources/assets/images/banner/banner09.jpg">
		<div class="container">
			...
			<div class="event-search bg_img"
				...
				<div class="event-search-top">
					...
					<div class="right">
						...
						<a href="sports-checkout" class="custom-button">book
							tickets</a>
					</div>
				</div>
			...
			<div class="row justify-content-between flex-wrap-reverse">
				...
				<div class="col-lg-5 col-md-7">
					<div class="event-about-thumb">
						<img src="./resources/assets/images/sports/sports-about.jpg" alt="sports">
					</div>
				</div>
			</div>
		</div>
